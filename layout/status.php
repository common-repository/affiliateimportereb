...
$results = WordpressDb::getInstance()->getDb()->get_var(
    'SELECT data FROM ' . WordpressDb::getInstance()->getDb()->prefix . EBDN_TABLE_ACCOUNT . " WHERE name='EBDN_EbayAccount'"
);
    ...
    <div class="tab_content" rel="backup_settings">
        ...
        <div class="text_content">
            ...
            <table class="settings_table">
                <tr>
                    <td><label>DevID</label></td>
                    <td><?= $settings['devID'] ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><label>CertID</label></td>
                    <td><?= $settings['certID'] ?></td>
                </tr>
            </table>
        </div>
        <div class="separator"></div>
