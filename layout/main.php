...
$imagePath = plugins_url('assets/img/main', EBDN_FILE_FULLNAME);
    ...
    <div class="tab_content" rel="backup_settings">
        ...
        <div class="text_content" style="margin-top: 15px">
            ...
            <span class="report_data">
                ...
                <span class="report_title">Total redirects to Ebay</span>
                </span>
            </span>
        ...
        <div class="text_content" style="margin-top: 15px; margin-bottom: 15px;">
            ...
            foreach ($products as $i => $product) {
                ...
                <div class="product_block">
                    ...
                    Views: <?= $product->hits ?>
                        <div class="separator"></div>
                    Redirect to Ebay: <?= $product->orders ?>
                        <div class="separator"></div>
                </span>
                    <div style="clear: both"></div>
                </div>
...
<script type="text/javascript">
    function buildLink() {
        location.href = 'admin.php?page=ebdn&limit=' + jQuery('#limit').val() + '&stats=' + jQuery('#stats').val();
    }
</script>